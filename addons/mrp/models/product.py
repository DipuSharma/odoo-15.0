...
# Hello Dipu Product_Product Model
class ProductProduct(models.Model):
    ...
    def _compute_mrp_product_qty(self):
        ...
        read_group_res = self.env['mrp.production'].read_group(domain, ['product_id', 'product_uom_qty'],
                                                               ['product_id'])
    ...
    def _compute_quantities_dict(self, lot_id, owner_id, package_id, from_date=False, to_date=False):
        ...
        res = super(ProductProduct, self - kits)._compute_quantities_dict(lot_id, owner_id, package_id,
        ...
        for product in bom_kits:
            ...
            for bom_line, bom_line_data in bom_sub_lines:
                ...
                if component.type != 'product' or float_is_zero(bom_line_data['qty'],
                ...
                qty_per_kit = bom_line.product_uom_id._compute_quantity(uom_qty_per_kit, bom_line.product_id.uom_id,
                                                                        round=False, raise_if_failure=False)
                if not qty_per_kit:
                    continue
    ...
    def _match_all_variant_values(self, product_template_attribute_value_ids):
        ...
        if not product_template_attribute_value_ids:
            return True
        for _, iter_ptav in groupby(product_template_attribute_value_ids.sorted('attribute_line_id'),
